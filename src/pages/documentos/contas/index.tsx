    ...
    return (
        <ContentDashboard>
            ...
            <DocumentUploadContainer
                title="Contas e Finanças"
                description="Envie e gerencie os relatórios de contas e demonstrativos financeiros da congregação."
                currentRoute="/documentos/contas"
