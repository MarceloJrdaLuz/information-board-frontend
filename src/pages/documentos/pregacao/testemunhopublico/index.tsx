...
import { Users, FolderArchive } from "lucide-react"
import { useEffect, useState } from "react"

function FieldPublicPage() {
    ...
    useEffect(() => {
        const categoryFilter = categories?.filter(category => category.name === Categories.testemunhoPublico)
        if (categoryFilter) {
    ...
    return (
        <ContentDashboard>
            ...
            <DocumentUploadContainer
                ...
                description="Envie e gerencie as programações e pontos de testemunho público com carrinhos."
                currentRoute="/documentos/pregacao/testemunhopublico"
...
FieldPublicPage.getLayout = withProtectedLayout(["ADMIN_CONGREGATION", "DOCUMENTS_MANAGER"])

export default FieldPublicPage
