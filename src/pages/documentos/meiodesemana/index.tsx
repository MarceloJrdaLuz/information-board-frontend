...
import { Calendar, FolderArchive } from "lucide-react"
    ...
    return (
        <ContentDashboard>
            ...
            <DocumentUploadContainer
                ...
                description="Envie e gerencie os arquivos PDF da programação de Nossa Vida e Ministério Cristão."
                currentRoute="/documentos/meiodesemana"
...
MeetingMidWeekPage.getLayout = withProtectedLayout(["ADMIN_CONGREGATION", "DOCUMENTS_MANAGER"])

export default MeetingMidWeekPage
