...
import { Sparkles, FolderArchive } from "lucide-react"
...
function CleanPage() {
    ...
    return (
        <ContentDashboard>
            <BreadCrumbs crumbs={crumbs} pageActive={"Limpeza"} />
            <DocumentUploadContainer
                title="Programação de Limpeza"
                description="Envie e gerencie as escalas e instruções de limpeza do Salão do Reino."
                currentRoute="/documentos/limpeza"
...
CleanPage.getLayout = withProtectedLayout(["ADMIN_CONGREGATION", "DOCUMENTS_MANAGER"])
