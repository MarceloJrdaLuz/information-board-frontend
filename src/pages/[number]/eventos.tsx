...
export default function Eventos({ circuit: congregationCircuit, name: congregationName, number: congregationNumber }: CongregationTypes) {
    ...
    return !pdfShow ? (
        <>
            ...
            <LayoutPrincipal congregationName={congregationName} circuit={congregationCircuit} textoHeader="Eventos" heightConteudo={'1/2'} header className="bg-cartas bg-left-bottom bg-cover lg:bg-right">
