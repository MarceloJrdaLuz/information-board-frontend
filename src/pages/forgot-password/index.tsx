...
function ForgotPassword() {
    return (
        <main className={`md:flex md:h-screen`}>
            ...
            <section className={`flex flex-wrap w-9/12 sm:w-2/3 h-4/5 absolute rounded-xl md:rounded-none top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 justify-center items-center md:w-5/12 md:h-full md:static md:transform-none bg-surface-200`}>
                <FormForgotPassword />
            </section>
        </main>
    )
