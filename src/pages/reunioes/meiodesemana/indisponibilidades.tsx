...
function MidweekUnavailabilitiesPage() {
    ...
    useEffect(() => {
        ...
        setCrumbs([
            ...
            { label: "Programação do Meio de Semana", link: "/reunioes/meiodesemana/programacao" }
        ]);
    ...
    }, [unavailabilities, searchTerm, statusFilter]);
            ...
            <div className="flex flex-col gap-5 w-full max-w-7xl mx-auto p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-surface-100 p-4 sm:p-5 rounded-xl border border-surface-300 shadow-sm gap-4">
                    <div className="flex items-center gap-3">
                        <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => router.push("/reunioes/meiodesemana/programacao")}
                        ...
                        <div>
                            ...
                            <p className="text-xs text-typography-500 mt-0.5">
                                Gerencie períodos de ausência, viagens ou impedimentos para evitar designações automáticas nessas datas.
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-surface-100 p-3 rounded-xl border border-surface-300 shadow-sm">
                    ...
                    <div className="relative w-full sm:w-72">
                        ...
                        <input
                            type="text"
                            placeholder="Buscar por publicador ou motivo..."
                            value={searchTerm}
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {filteredUnavailabilities.map((item) => {
                            ...
                            const isPast = end.isBefore(today, "day");
...
export default MidweekUnavailabilitiesPage;
