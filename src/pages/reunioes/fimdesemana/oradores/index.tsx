...
function SpeakersPage() {
    ...
    const [selectedSpeakerForSchedule, setSelectedSpeakerForSchedule] = useState<ISpeaker | null>(null)
    const [isScheduleModalOpen, setIsScheduleModalOpen] = useState(false)
    const [searchSpeaker, setSearchSpeaker] = useState("")
    const [searchTalkNumber, setSearchTalkNumber] = useState("")
    ...
    useEffect(() => {
        setPageActive('/reunioes/fimdesemana/oradores')
        setCrumbs([
            ...
            <section className="flex flex-col w-full min-h-full p-3 sm:p-5 md:p-6 gap-6 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-4 bg-surface-100 border border-surface-300 rounded-2xl p-4 sm:p-5 shadow-sm">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <Button
                            outline
                            onClick={() => Router.push('/reunioes/fimdesemana/oradores/add')}
                ...
                {!speakers ? (
                    ...
                    <ListGeneric
                        ...
                        path="/reunioes/fimdesemana/oradores"
                        label="do Orador"
                        renderItem={(speaker) => {
