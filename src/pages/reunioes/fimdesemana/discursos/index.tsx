...
function TalksPage() {
    ...
    const { data: talks, mutate, isLoading } = useAuthorizedFetch<ITalk[]>('/talks', {
        allowedRoles: ["TALK_MANAGER", "ADMIN_CONGREGATION", "ADMIN"]
    })
    ...
    useEffect(() => {
        setPageActive('/reunioes/fimdesemana/discursos')
        setCrumbs([
            ...
            <section className="flex flex-col w-full min-h-full p-3 sm:p-5 md:p-6 gap-6 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-4 bg-surface-100 border border-surface-300 rounded-2xl p-4 sm:p-5 shadow-sm">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        {roleContains('ADMIN') && (
                            <Button
                                outline
                                onClick={() => Router.push('/reunioes/fimdesemana/discursos/add')}
                ...
                {!talks ? (
                    ...
                    <ListGeneric
                        ...
                        items={filteredTalks}
                        path="/reunioes/fimdesemana/discursos"
                        label="do Discurso"
                        renderItem={(talk) => (
