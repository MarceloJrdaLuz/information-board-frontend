            ...
            <DialogContent className="max-w-md">
                ...
                <div className="space-y-4 py-2">
                    <div className="space-y-2">
                        <label className="text-xs font-semibold text-typography-700 uppercase tracking-wider">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="space-y-0.5">
                                            <div className="flex items-center gap-2 font-medium text-sm text-typography-800">
                                                <span>{opt.label}</span>
                                                {opt.count === 3 && (
                                            ...
                                            <p className="text-xs text-typography-500">{opt.desc}</p>
                                        </div>
                                        <div
                    ...
                    {/* Resumo do Período */}
                    <div className="p-3 rounded-lg bg-surface-200 border border-surface-300 text-xs space-y-1">
                        <div className="flex items-center gap-1.5 font-medium text-typography-700">
                            <CalendarRange className="w-4 h-4 text-blue-600" />
                            <span>Período: <strong className="capitalize text-typography-900">{monthFormatted || "Carregando..."}</strong></span>
                        </div>
                        <div className="text-typography-500 pl-5">
                            {loadingData ? (
