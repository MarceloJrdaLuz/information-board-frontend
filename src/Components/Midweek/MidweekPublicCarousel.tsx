        ...
        <div className="relative w-full flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center bg-surface-100 p-3 rounded-2xl border border-surface-300 shadow-sm">
                ...
                <h2 className="text-base sm:text-lg font-extrabold text-typography-900 capitalize tracking-tight flex items-center gap-2">
                    ...
                    <span>{months[activeIndex]?.[0] || "Programação"}</span>
                </h2>
            ...
            {/* Lista de Semanas do Mês Ativo */}
            {months.map(([monthKey, weeks], index) => (
                <div key={monthKey} className={index === activeIndex ? "flex flex-col gap-5" : "hidden"}>
                    {weeks.map((week) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* CORPO DO CARD: Se for evento especial sem reunião, exibe aviso e observação em vermelho do sistema */}
                                {isNoMeetingSpecial ? (
                                    ...
                                    <div className="p-4 sm:p-6 flex flex-col gap-6 divide-y divide-surface-300">
                                        ...
                                        {/* 1. TESOUROS DA PALAVRA DE DEUS (Header oficial #2F7682) */}
                                        {treasuresParts.length > 0 && (
                                            <div className="pt-5 flex flex-col gap-3">
                                                ...
                                                <div className="flex flex-col gap-2.5">
                                                    ...
                                                    {/* Leitura da Bíblia com identificação explícita de Salas */}
                                        ...
                                        {/* 2. FAÇA SEU MELHOR NO MINISTÉRIO (Header oficial #D49000) */}
                                        ...
                                        {/* 3. NOSSA VIDA CRISTÃ (Header oficial #BA2A12) */}
