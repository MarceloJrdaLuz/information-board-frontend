...
export default function ListMonths(props: ListRelatoriosProps) {
    ...
    return (
        <section className="flex flex-col flex-1 h-[90%] overflow-auto thin-scrollbar">
            ...
            <Button  className="m-5 bg-white font-semibold text-primary-200 p-3 border-gray-300 rounded-none hover:opacity-80" onClick={() => router.push(`/congregacao/relatorios/${congregationId}/cartao-publicador`)}>
                Criar registros
                <FileSpreadsheetIcon/>
            </Button>
