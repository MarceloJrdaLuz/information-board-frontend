...
export default function SkeletonContactsEmergencyList() {
    return (
        <li
                ...
                <div className="border p-4 rounded-md">
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                        <div className="flex gap-1">
                            <div className="h-5 w-5 bg-surface-200 shimmer rounded" />
                            <div className="h-5 w-1/2 bg-surface-200 shimmer rounded" />
                        </div>
                        <div className="flex gap-1">
                            <div className="h-5 w-5 bg-surface-200 shimmer rounded" />
                            <div className="h-5 w-1/2 bg-surface-200 shimmer rounded" />
