...
export default function ButtonHamburguer({ onClick }: ButtonHamburguerProps) {
    ...
    return (
        <button onClick={toggleValue} className={`md:hidden fixed top-4 left-4 z-50 transition-all`}>
            <div className=" relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-slate-700 ring-0 ring-typography-300 duration-200 text-typography-200">
