                ...
                >
                  <div className="flex flex-col gap-3 w-full">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="h-4 w-28 bg-surface-200 rounded-md" />
                      <div className="h-4 w-28 bg-surface-200 rounded-md" />
                      <div className="h-4 w-40 bg-surface-200 rounded-md col-span-2" />
                    </div>
                  </div>
                  <div className="ml-4 h-8 w-20 bg-surface-200 rounded-md" />
                </div>
              ))}
            </div>
