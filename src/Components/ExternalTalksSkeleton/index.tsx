  ...
  return (
    <section className="w-full h-full p-5 animate-pulse">
      ...
      <div className="flex justify-between my-4 p-4">
        <div className="h-9 w-28 bg-typography-200 rounded-md" />
        <div className="h-9 w-28 bg-typography-200 rounded-md" />
      </div>
      ...
      <div className="space-y-6">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="rounded-xl p-4 flex flex-col gap-6 bg-typography-50 border shadow-sm"
          >
            {/* Data */}
                ...
                >
                  <div className="flex flex-col gap-3 w-full">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <div className="h-5 w-40 bg-typography-200 rounded-md" />
                      <div className="h-4 w-24 bg-typography-200 rounded-md" />
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="h-4 w-28 bg-typography-200 rounded-md" />
                      <div className="h-4 w-28 bg-typography-200 rounded-md" />
                      <div className="h-4 w-40 bg-typography-200 rounded-md col-span-2" />
                    </div>
                  </div>
                  <div className="ml-4 h-8 w-20 bg-typography-200 rounded-md" />
                </div>
              ))}
            </div>
