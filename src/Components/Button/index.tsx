...
const button = tv({
  ...
  variants: {
    ...
    outline: {
      false: "bg-gradient-to-tl from-primary-150 to-primary-200 text-surface-100 border-current hover:opacity-90",
      true: "border-typography-300 hover:border-current rounded-none bg-surface-100 hover:bg-surface-200 p-3 text-primary-200 font-semibold shadow-none"
    },
    disabled: {
