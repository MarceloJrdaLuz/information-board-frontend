...
const button = tv({
    base: 'flex justify-center items-center transition-all gap-2 duration-500 bg-primary-200 active:shadow-none shadow-xl  rounded-lg hover:opacity-90 border border-current  text-xs xs:text-sm sm:text-md lg:text-base text-white justify-self-center h-[40px] w-36',
    variants: {
        size: {
            default: 'px-2 py-2',
            sm: 'w-28 py-2',
