...
const Input = forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  ...
  return (
    <div
      ...
      } relative flex items-center rounded-lg border-[2px] ${
        invalid === "invalido"
          ? "border-red-400 mb-1"
    ...
    >
      {mask ? (
        <InputMask
          ...
          className={`block px-3 py-2.5 w-full text-sm text-black appearance-none placeholder-transparent focus:outline-none rounded-xl bg-transparent read-only:bg-gray-300 read-only:rounded-lg font-sans font-normal text-left ${
