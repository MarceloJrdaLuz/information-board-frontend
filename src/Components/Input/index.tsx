...
export default function Input(props: InputProps) {
    ...
    return (
        <div className={` ${props.readOnly ? 'focus-within:outline border-none' : 'outline' } relative flex items-center rounded-lg border-[2px] ${props.invalid === 'invalido' ? 'border-red-600 mb-1': 'border-blue-gray-200'} focus-within:border-primary-100 focus-within:border-2 outline-0 my-3 w-full h-full m-auto ${props.className}`}>
            <input
