...
export default function Footer({ ano, nomeCongregacao, aviso, nCong }: FooterProps) {
  ...
  return (
    <footer className={`${!isDark ? "bg-gradient-to-t from-primary-100 to-primary-200" : "border border-t-typography-800 bg-gradient-to-b from-surface-100 to-surface-200"}  border-surface-200 text-surface-100 py-6 text-sm sm:text-base`}>
