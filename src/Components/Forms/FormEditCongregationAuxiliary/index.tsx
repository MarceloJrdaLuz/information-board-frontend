        ...
        <section className="flex w-full justify-center items-center h-full m-2">
            <FormStyle onSubmit={handleSubmit(onSubmit, onError)}>
                <div className="w-full flex flex-col">
                    <div className="form-title-modern">Atualizar Congregação</div>
                    ...
                    <div className="w-full mt-6">
                        <Button className='w-full text-typography-200' disabled={disabled} success={dataSuccess} error={dataError} type='submit' >Atualizar Congregação</Button>
                    </div>
                </div>
            </FormStyle>
        </section>
